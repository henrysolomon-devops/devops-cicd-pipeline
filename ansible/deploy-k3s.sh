...
# infrastructure changes. The APP_SERVER_IP naming from v7 (when a
# second, Jenkins server existed alongside this one) is gone as of v8,
# now that there's only one server again.
set -euo pipefail
